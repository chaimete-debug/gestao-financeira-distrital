...
async function serverCall(fnName,args,onSuccess,onFailure){
  ...
  const noCache = ['Lancamento_create','Lancamento_createAndSubmit','Lancamento_submit','Approval_decide',
...
function guardarLancamento(modo){
  ...
  if(modo==='SUBMETER'){
    // CORRECÇÃO: createAndSubmit é atómico — evita race condition entre create e submit
